...
class IgnoreExecutionServiceTest {
    ...
    void skipExecutionByExecution() {
        ...
        ignoreExecutionService.setIgnoredFlows(List.of("namespace|skip"));
    ...
    void skipExecutionByFlowId() {
        ...
        ignoreExecutionService.setIgnoredFlows(List.of(flowToSkip, flowToSkipWithTenant));

        assertThat(ignoreExecutionService.ignoreExecution(null, "namespace", "skip", "random")).isTrue();
        assertThat(ignoreExecutionService.ignoreExecution(null, "wrong", "skip", "random")).isFalse();
        ...
        assertThat(ignoreExecutionService.ignoreExecution(null, "namespace", "not_skipped", "random")).isFalse();
    ...
    void skipExecutionByNamespace() {
        ...
        assertThat(ignoreExecutionService.ignoreExecution(null, "namespace", "someFlow", "someExecution")).isFalse();
